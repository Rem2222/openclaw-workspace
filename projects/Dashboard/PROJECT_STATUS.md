...
- [ ] **workspace-ywz:** Убрать выпадающий список сессий (не проекта) из Монитора
- [ ] **workspace-d1f:** Projects — при нажатии Монитор фильтр по проекту не устанавливается
- [ ] **workspace-ha2:** Убрать кнопку Архивировать из Проектов
- [ ] **workspace-k1r:** Projects — в меню (рядом с Монитор) добавить Сессия/Агент
- [ ] **workspace-wu4:** Сессии/Субагенты — при клике на проект открывать Монитор
