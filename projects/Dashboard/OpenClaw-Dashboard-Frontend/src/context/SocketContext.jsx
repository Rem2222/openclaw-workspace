...
export function SocketProvider({ children }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log('[SocketContext] Connecting to:', socketUrl || '(same origin)', '(DEV:', isDev, ')');
