...
router.get('/', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in /api/approvals:', error.message);
...
router.get('/stats', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in /api/approvals/stats:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.get('/:id', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in /api/approvals/:id:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in POST /api/approvals:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/:id/approve', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in POST /api/approvals/:id/approve:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/:id/reject', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in POST /api/approvals/:id/reject:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in DELETE /api/approvals/:id:', error.message);
    res.status(500).json({ error: error.message });
  }
});
...
router.post('/cleanup', async (req, res) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.error('❌ Error in POST /api/approvals/cleanup:', error.message);
    res.status(500).json({ error: error.message });
  }
});
