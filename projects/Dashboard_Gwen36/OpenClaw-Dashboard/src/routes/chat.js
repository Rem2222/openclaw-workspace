...
router.post('/send', async (req, res) => {
  try {
    ...
    // TODO: Validate message content (sanitize, length limit) before writing to JSONL
    ...
    if (process.env.NODE_ENV === 'development') console.log(`[chat] Message appended to session ${sessionKey}`);
    ...
    if (process.env.NODE_ENV === 'development') console.error('[chat] Error sending message:', error.message);
