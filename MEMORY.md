...
## Аббревиатуры и глоссарий (2026-03-29)

- **ЛКМ** — (пользователь использует, расшифровку уточнить) — возможно "Личный Кабинет Мессенджера" или что-то в Workspace/проекте Романа. Уточнить при следующей встрече.
