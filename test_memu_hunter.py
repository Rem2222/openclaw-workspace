#!/usr/bin/env python3
"""Простая memory system через OpenRouter — Hunter Alpha"""
    ...
    def memorize(self, text):
        ...
        response = requests.post(
            ...
            json={
                ...
                "max_tokens": 300,
                "messages": [
                    {"role": "system", "content": "Extract 3-5 key facts from text. Return ONLY valid JSON: {"facts": ["string"], "category": "string", "importance": 5}"},
    ...
    def retrieve(self, query):
        ...
        response = requests.post(
            ...
            json={
                ...
                "max_tokens": 300,
                "messages": [
                    {"role": "system", "content": "Find relevant memories for query. Return JSON: {"results": [{"memory": {...}, "relevance": 0.9}]}"},
...
def main():
    print("🚀 Simple Memory System (Hunter Alpha)\n")
